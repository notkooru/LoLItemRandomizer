...
#runes
#precision
precision_keystone.append(Rune("Press the Attack"))
precision_keystone.append(Rune("Lethal Tempo"))
precision_keystone.append(Rune("Fleet Footwork"))
precision_keystone.append(Rune("Conqueror"))
precision_slot1.append(Rune("Overheal"))
precision_slot1.append(Rune("Triumph"))
precision_slot1.append(Rune("Presence of Mind"))
precision_slot2.append(Rune("Legend:Alacrity"))
precision_slot2.append(Rune("Legend:Tenacity"))
precision_slot2.append(Rune("Legend:Bloodline"))
precision_slot3.append(Rune("Coup de Grace"))
precision_slot3.append(Rune("Cut Down"))
precision_slot3.append(Rune("Last Stand"))
#domination
domination_keystone.append(Rune("Electrocute"))
domination_keystone.append(Rune("Predator"))
domination_keystone.append(Rune("Dark Harvest"))
domination_keystone.append(Rune("Hail of Blades"))
domination_slot1.append(Rune("Cheap Shot"))
domination_slot1.append(Rune("Taste of Blood"))
domination_slot1.append(Rune("Sudden Impact"))
domination_slot2.append(Rune("Zombie Ward"))
domination_slot2.append(Rune("Ghost Poro"))
domination_slot2.append(Rune("Eyeball Collection"))
domination_slot3.append(Rune("Treasure Hunter"))
domination_slot3.append(Rune("Ingenious Hunter"))
domination_slot3.append(Rune("Relentless Hunter"))
domination_slot3.append(Rune("Ultimate Hunter"))
#sorcery
sorcery_keystone.append(Rune("Summon Aery"))
sorcery_keystone.append(Rune("Arcane Comet"))
sorcery_keystone.append(Rune("Phase Rush"))
sorcery_slot1.append(Rune("Nullifying Orb"))
sorcery_slot1.append(Rune("Manaflow Band"))
sorcery_slot1.append(Rune("Nimbus Cloak"))
sorcery_slot2.append(Rune("Transcendence"))
sorcery_slot2.append(Rune("Celerity"))
sorcery_slot2.append(Rune("Absolute Focus"))
sorcery_slot3.append(Rune("Scorch"))
sorcery_slot3.append(Rune("Waterwalking"))
sorcery_slot3.append(Rune("Gathering Storm"))
#resolve
resolve_keystone.append(Rune("Grasp of the Undying"))
resolve_keystone.append(Rune("Aftershock"))
resolve_keystone.append(Rune("Guardian"))
resolve_slot1.append(Rune("Demolish"))
resolve_slot1.append(Rune("Font of Life"))
resolve_slot1.append(Rune("Shield Bash"))
resolve_slot2.append(Rune("Conditioning"))
resolve_slot2.append(Rune("Second Wind"))
resolve_slot2.append(Rune("Bone Plating"))
resolve_slot3.append(Rune("Overgrowth"))
resolve_slot3.append(Rune("Revitalize"))
resolve_slot3.append(Rune("Unflinching"))
#inspiration
inspiration_keystone.append(Rune("Glacial Augment"))
inspiration_keystone.append(Rune("Unsealed Spellbook"))
inspiration_keystone.append(Rune("First Strike"))
inspiration_slot1.append(Rune("Hextech Flashtraption"))
inspiration_slot1.append(Rune("Magical Footwear"))
inspiration_slot1.append(Rune("Perfect Timing"))
inspiration_slot2.append(Rune("Future's Market"))
inspiration_slot2.append(Rune("Minion Dematerializer"))
inspiration_slot2.append(Rune("Biscuit Delivery"))
inspiration_slot3.append(Rune("Cosmic Insight"))
inspiration_slot3.append(Rune("Approach Velocity"))
inspiration_slot3.append(Rune("Time Warp Tonic"))
#trees
